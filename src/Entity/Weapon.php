 ...
 * )
 */
final class Weapon extends RevisionableContentEntityBase implements WeaponInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type): array {
    ...
    $fields['created'] = BaseFieldDefinition::create('created')
      ...
      ->setTranslatable(TRUE)
      ->setDescription(t('The time that the weapon was created.'))
      ->setDisplayOptions('view', [
        'label' => 'above',
        'type' => 'timestamp',
        'weight' => 20,
    ...
    $fields['changed'] = BaseFieldDefinition::create('changed')
      ->setLabel(t('Changed'))
      ->setTranslatable(TRUE)
      ->setDescription(t('The time that the weapon was last edited.'));
